...
\begin{itemize}
    ...
    \item \textbf{Owner}: Mac
    \item \textbf{Testing}: The existing validation tests reject impossible \texttt{PUT} (e.g., \texttt{threshold\_m > total\_n}). 
