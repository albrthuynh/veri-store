...
class Polynomial:
    ...
    def __init__(self, coeffs: Sequence[GF256 | int]) -> None:
        ...
        """
        # TODO: Normalise coefficients (strip trailing zeros, wrap ints).
        ...
    ...
    def from_bytes(cls, data: bytes) -> Polynomial:
        ...
        """
        # TODO: Map each byte to GF256(byte) and construct polynomial.
        ...
    ...
    def evaluate(self, point: GF256) -> GF256:
        ...
        """
        # TODO: Implement Horner's method iterating from high to low degree.
        ...
    ...
    def __add__(self, other: Polynomial) -> Polynomial:
        ...
        """
        # TODO: Pad the shorter coefficient list and XOR pairwise.
        ...
    ...
    def __sub__(self, other: Polynomial) -> Polynomial:
        ...
        Returns:
            A new Polynomial equal to self - other.
        """
        # TODO: Same as __add__ in characteristic 2.
        ...
    ...
    def __mul__(self, other: Polynomial | GF256) -> Polynomial:
        ...
        Returns:
            A new Polynomial equal to self * other.
        """
        # TODO: Implement schoolbook polynomial multiplication,
        #       or scalar multiplication if other is GF256.
        ...
    ...
    def divide_by_linear(self, root: GF256) -> tuple[Polynomial, GF256]:
        ...
        """
        # TODO: Implement synthetic (Horner) division.
        ...
    ...
    def degree(self) -> int:
        ...
        """
        # TODO: Find the last non-zero coefficient.
        ...
    ...
    def to_bytes(self) -> bytes:
        ...
        """
        # TODO: Convert each GF256 element to its integer value.
        ...

    def __eq__(self, other: object) -> bool:
        """Equality check (coefficient-wise)."""
        # TODO: Compare .coeffs lists.
        ...

    def __repr__(self) -> str:
        """Human-readable polynomial representation."""
        # TODO: Format as "c0 + c1*x + c2*x^2 + ..."
        ...
